class LlvmAT701 < Formula
  ...
  stable do
    ...
    resource "test-suite" do
      url "http://releases.llvm.org/7.0.1/test-suite-7.0.1.src.tar.xz"
      sha256 "199c6f5422779c002eda1112c7e813fedff4d54f94d994cebc8270e5b68aea4c"
    end
  end
